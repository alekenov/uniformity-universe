...
const OrderSummary: React.FC<OrderSummaryProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-3 mb-3 text-sm">
      ...
      <div className="mt-2 bg-[#FEF7F8] rounded-lg p-3 flex">
        ...
        <div>
          <p className="text-xs font-medium mb-0.5">Помощь рядом</p>
          <p className="text-xs text-gray-600 leading-tight">Подключите округление заказов, чтобы помогать благотворительным фондам</p>
        </div>
      </div>
